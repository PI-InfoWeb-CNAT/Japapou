...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ['tipo_usuario', 'username', 'email', 'first_name', 'last_name', 'is_staff', 'telefone', 'endereco', 'cpf', 'data_nascimento', 'foto_perfil', 'cnh', 'modelo_moto']

    # utilizado para mostrar os novos campos que iram aparecer quando editar um usuario na area administrativa
    fieldsets = UserAdmin.fieldsets + (
        ('Campos Extras', {'fields': ('tipo_usuario', 'telefone', 'endereco', 'cpf', 'data_nascimento', 'foto_perfil', 'cnh', 'modelo_moto')}),
    )
